...
INSERT INTO `qna` VALUES (1,'서비스','서비스는 누가 받을 수 있나요?','비회원인 사람도 서비스 혜택을 받을 수 있나요?','2021-07-15 18:40:46',3,'답변완료'),(2,'객실','객실의 인원 제한은 몇 명인가요?','코로나 이전과 이후로의 객실 인원 제한을 알고싶습니다.','2021-07-15 18:41:11',3,'답변완료'),(3,'기타','포인트 적립은 어떻게 진행되나요?','저는 가입된 회원인데 적립은 어떻게 되는건가요?\n','2021-07-15 18:41:45',3,'답변완료'),(4,'기타','조식은 얼마인가요?','조식 할인은 없나요?','2021-07-15 18:42:13',3,'답변완료'),(5,'서비스','서비스에도 종류가 있나요?','예약한 패키지의 서비스 항목이 따로 나뉘어져있나요?','2021-07-15 18:42:56',4,'답변완료'),(6,'서비스','직원들 소리함은 있나요?','직원들에게 칭찬을 하고 싶은데 어떻게 하면 되나요?','2021-07-15 18:43:20',4,'답변완료'),(7,'객실','음식을 먹어도 되나요?','객실에서 어느 정도까지의 음식의 반입이 허용되나요?','2021-07-15 18:43:51',4,'답변완료'),(8,'기타','포인트 소멸 기간은 어떻게 되나요?','사정이 있어서  포인트를 다 못 쓸 것 같습니다. 이월이 되는건가요?','2021-07-15 18:44:25',4,'답변완료'),(9,'서비스','서비스에도 등급이 나뉘어져있나요?','서비스 혜택을 받는데도 등급에 따라 달라지나요?','2021-07-15 18:45:13',5,'답변완료'),(10,'서비스','각종 혜택을 어떻게 알 수 있나요?','혜택을 따로 알아볼 수 있는 창이 있나요?','2021-07-15 18:45:40',5,'답변완료'),(11,'객실','객실에서 물건을 파손하면 어떻게 배상을 해야하나요?','이번 호텔가서 아이랑 같이 즐기다가 물건을 파손했는데 어떻게 배상 해야하나요?','2021-07-15 18:46:40',5,'답변완료'),(12,'기타','야외 활동을 즐길 수 있는 이벤트가 있나요?','실내 말고 실외로 즐길 수 있는 이벤트가 있을까요?','2021-07-15 18:47:13',5,'답변완료'),(13,'객실','체크인과 체크아웃 시간이 어떻게 되나요?','방 별로 시간이 나뉘어져 있나요 아님 통합인가요?','2021-07-15 18:48:04',6,'답변완료'),(14,'객실','강아지를 데리고 가도 되나요?','애완동물을 키우는데 데려가도 되나요?','2021-07-15 18:48:21',6,'답변완료'),(15,'기타','마이크를 들고 가도 되나요?','스피커랑 마이크는 가져가면 안되나요?','2021-07-15 18:48:53',6,'답변완료'),(16,'서비스','어른이 즐길 수 있는 액티비티는 없나요?','스파 이런거 말고 더 없나요?','2021-07-15 18:50:17',8,'답변완료'),(17,'서비스','만족도 조사는 따로 하지 않나요?','직원들이 너무 친절하셔서 그러는데 만족도 조사는 안하나요?','2021-07-15 18:50:46',8,'답변완료'),(18,'객실','2명을 예약했는데 한 명 더 추가해도 되나요?','손님이 계시는데 기존 예약 인원에서 따로 추가해도 되나요?','2021-07-15 18:51:37',8,'답변완료'),(19,'서비스','서비스를 받는 유형은 어떤가요?','영유아부터 노인까지 어떤 서비스가 있나요?','2021-07-15 19:07:40',3,'답변완료'),(20,'기타','호텔 부근에 주차장이 있나요?','주차장 유무를 알고싶습니다.','2021-09-10 07:49:30',6,'답변완료'),(21,'객실','객실에 조식 서비스도 포함이 되나요?','객실로 서비스가 오는 건가요?','2021-09-10 07:50:03',6,'답변완료'),(22,'서비스','직원들은 어떻게 배치되나요?','각 서비스에 배치되는 직원의 인원은 어떻게 되나요?','2021-09-16 10:04:34',5,'답변완료'),(23,'객실','객실은 각각 뷰가 어떤가요?','객실마다 뷰는 어떻게 되나요?\n','2021-09-16 10:05:13',5,'답변완료'),(24,'기타','아이는 총 몇명까지 예약이 가능한가요?','아이들이 있습니다. 몇 명까지 예약이 가능한가요?','2021-09-16 10:05:37',5,'답변완료'),(25,'서비스','서비스를 처음 이용해봅니다. 어떤식으로 이뤄지는지 알고싶습니다.','서비스의 종류는 어떻게 됩니까?','2021-09-16 10:06:27',8,'답변완료'),(26,'객실','객실은 최대 몇 명이 이용가능한가요?','객실은 최대 몇 명이 이용가능한가요?','2021-09-16 10:08:13',8,'답변완료'),(27,'기타','수영장은 몇 시부터 이용이 가능한가요?','수영장은 몇 시부터 이용이 가능한가요?','2021-09-16 10:08:27',8,'답변완료'),(28,'기타','수영장에서는 수영모가 필수인가요?','수영장에서는 수영모가 필수인가요?','2021-09-16 10:08:41',8,'답변완료'),(29,'객실','본관으로 가는 길은 무엇인가요?','본관으로 방이 잡혀있어서 가고 싶은데 가는 법을 모르겠습니다.','2021-09-16 10:09:19',8,'답변완료'),(31,'서비스','번호를 변경하였습니다. 기존 정보는 그대로 옮겨지나요?','번호를 변경했는데 기존의 정보들은 바뀐 번호로 바뀌어지나요?','2021-09-16 10:21:56',9,'답변완료'),(32,'객실','침대 베드가 푹 꺼졌습니다. 베드 변경 처리는 어떻게 되나요?','침대 베드가 푹 꺼졌습니다. 베드 변경 처리는 어떻게 되나요?','2021-09-16 10:22:37',9,'답변완료'),(33,'객실','객실 청소는 일일 몇 번 하나요?','객실 청소는 하루에 얼마나 이루어지나요?','2021-09-16 10:23:10',9,'답변완료'),(34,'객실','방역이 중요한데 어떻게 처리되나요?','요즘 코로나 19로 인해 걱정이 많은데 방역은 어떻게 이루어지나요?','2021-09-16 10:23:32',9,'답변완료'),(35,'기타','이벤트에도 나이 제한이 있나요?','성인이 이용할 수 있어도 제한이 있을까요?','2021-09-16 10:23:55',9,'답변완료'),(36,'기타','이벤트에도 키 제한이 있나요?','아이와 같이 이벤트를 이용할 건데, 키 제한은 어떻게 되나요?','2021-09-16 10:24:20',9,'답변완료');
...
CREATE TABLE `rqna` (
  ...
  `qstate` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`no`)
) ENGINE=InnoDB AUTO_INCREMENT=144 DEFAULT CHARSET=euckr;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rqna` VALUES (106,'키 제한은 특별히 없습니다. 다만, 이벤트마다 제한이 되는 경우가 있을 수도 있으니 홈페이지 참고 바랍니다.',36,'이벤트에도 키 제한이 있나요?','2021-09-16 10:25:07','답변완료'),(110,'성인의 이벤트는 연령 제한이 없습니다. 다만, 수영장은 건강 상태에 따라 이용 가능한 지를 로비에서 검사하기 때문에 거기에 대한 답변은 달라질 것입니다. ',35,'이벤트에도 나이 제한이 있나요?','2021-09-16 10:31:31','답변완료'),(111,'1일 3회 방역 작업을 합니다.',34,'방역이 중요한데 어떻게 처리되나요?','2021-09-16 10:34:48','답변완료'),(112,'객실 청소는 1일 2회 합니다. 예약 시간이 2타임으로 이루어져 있기 때문에 그렇습니다.',33,'객실 청소는 일일 몇 번 하나요?','2021-09-16 10:35:14','답변완료'),(113,'이용에 불편을 드려 정말 죄송합니다. 베드 처리는 일단, 가격 면에서 침실 예약의 40%를 환불 해드립니다. 그리고 이상이 있는 베드는 즉각 변경이 가능합니다. 애로 사항을 우선시하고 만족을 드리는 델루나 호텔이 되겠습니다. 감사합니다.',32,'침대 베드가 푹 꺼졌습니다. 베드 변경 처리는 어떻게 되나요?','2021-09-16 11:02:08','답변완료'),(114,'기존의 이름과 아이디가 저장 되어있기 때문에 번호를 바꾸셔도 정보는 그대로 가지고 있습니다. ',31,'번호를 변경하였습니다. 기존 정보는 그대로 옮겨지나요?','2021-09-16 11:02:37','답변완료'),(115,'홈페이지의 약도를 참조하시기 바랍니다.',29,'본관으로 가는 길은 무엇인가요?','2021-09-16 14:14:34','답변완료'),(116,'어른에 대한 이벤트는 이벤트 페이지를 참고하시기 바랍니다.',16,'어른이 즐길 수 있는 액티비티는 없나요?','2021-09-16 14:22:35','답변완료'),(117,'실내 수영장에서는 수영모가 필수입니다. 야외 수영장에서는 괜찮습니다.',28,'수영장에서는 수영모가 필수인가요?','2021-09-16 14:23:32','답변완료'),(118,'수영장은 시간마다 예약제로 운영되는데, 오전 9시부터 시작됩니다.',27,'수영장은 몇 시부터 이용이 가능한가요?','2021-09-16 14:24:07','답변완료'),(119,'객실은 최대 4인이었으나, 코로나 4단계 격상으로 인해 최대 2인만 됩니다.',26,'객실은 최대 몇 명이 이용가능한가요?','2021-09-16 14:24:30','답변완료'),(120,'서비스의 종류는 회원, 비회원 서비스로 나뉘는데 이용하실 수 있는 서비스는 마이페이지 페이지에서 확인이 가능합니다.',25,'서비스를 처음 이용해봅니다. 어떤식으로 이뤄지는지 알고싶습니다.','2021-09-16 14:25:23','답변완료'),(121,'어린이는 최대 2인이 가능합니다.',24,'아이는 총 몇명까지 예약이 가능한가요?','2021-09-16 14:27:15','답변완료'),(122,'뷰는 마운틴 뷰, 건물 뷰, 씨 뷰가 있습니다.',23,'객실은 각각 뷰가 어떤가요?','2021-09-16 14:27:42','답변완료'),(123,'각 서비스마다 직원은 최소 2인에서 최대 4인으로 배치되어 있습니다.',22,'직원들은 어떻게 배치되나요?','2021-09-16 14:28:11','답변완료'),(124,'조식 서비스는 따로 방으로 이동하지 않고 레스토랑으로 이동하여서 이용하셔야 합니다.',21,'객실에 조식 서비스도 포함이 되나요?','2021-09-16 14:28:41','답변완료'),(125,'호텔 뒷 편으로 가시면 주차장이 마련되어 있습니다. 그리고 지하, 지상 주차장이어서  자리 수에 제한 없이 이용하실 수 있습니다.',20,'호텔 부근에 주차장이 있나요?','2021-09-16 14:29:23','답변완료'),(126,'영유아부터 고령자가 즐길 수 있는 서비스는 이벤트와 마이페이지 페이지를 참조하시면 보다 더 정확하고 자세한 내용을 확인하실 수 있습니다.',19,'서비스를 받는 유형은 어떤가요?','2021-09-16 14:30:03','답변완료'),(127,'인원 추가는 예약할 때부터 하셔야 합니다. 중간에 추가는 어렵습니다. 홈페이지를 참고하여 주십시오.',18,'2명을 예약했는데 한 명 더 추가해도 되나요?','2021-09-16 14:33:12','답변완료'),(128,'칭찬 감사드립니다. 저희 호텔에서는 현재 만족도 조사는 따로 하고 있지 않습니다. 직원들에게 전달하여 기쁨을 나누겠습니다. 앞으로도 고객님의 입장에서, 그리고 고객에게 만족을 드리는 호텔로 거듭나겠습니다. 항상 감사드립니다.',17,'만족도 조사는 따로 하지 않나요?','2021-09-16 14:34:16','답변완료'),(129,'숙소 내에서는 마이크랑 스피커의 음량은 볼륨 7로 제한됩니다. 소지는 가능하나 제한이 있다는 점을 알아두십시오.',15,'마이크를 들고 가도 되나요?','2021-09-16 14:34:53','답변완료'),(130,'반려견은 출입이 금지되어 있습니다. ',14,'강아지를 데리고 가도 되나요?','2021-09-16 14:35:13','답변완료'),(131,'방 별로 체크인과 체크아웃 시간은 동일합니다. 하지만 체크 아웃 시간은 1시간 주기로 추가를 할 수 있습니다. 룸 페이지를 참조하십시오.',13,'체크인과 체크아웃 시간이 어떻게 되나요?','2021-09-16 14:35:49','답변완료'),(132,'예를 들어, 수영장과 야외 바가 마련되어 있습니다. 더 자세한 상황은 Lifestyle 페이지를 참고하십시오.',12,'야외 활동을 즐길 수 있는 이벤트가 있나요?','2021-09-16 14:36:34','답변완료'),(133,'호텔 파손에 대한 점은, 법률 조항에 따라 조치됩니다. 이에 대한 점은 개인적으로 연락이 갈 것입니다. 확인바랍니다.',11,'객실에서 물건을 파손하면 어떻게 배상을 해야하나요?','2021-09-16 14:37:02','답변완료'),(134,'고객님께 맞는 혜택은 마이페이지 창을 이용하시면 자세히 알 수 있습니다.',10,'각종 혜택을 어떻게 알 수 있나요?','2021-09-16 14:37:35','답변완료'),(135,'서비스는 VIP, VVIP 등 등급에 따른 혜택이 나눠져있습니다. 자세한 내용은 마이페이지를 확인하십시오.',9,'서비스에도 등급이 나뉘어져있나요?','2021-09-16 14:38:16','답변완료'),(136,'포인트는 따로 이월되지 않습니다. 포인트는 1년, 1달 주기로 알려드리기 때문에 이용에 참조 바랍니다.',8,'포인트 소멸 기간은 어떻게 되나요?','2021-09-16 14:38:47','답변완료'),(137,'모든 종류의 음식은 반입이 가능합니다. 단, 주류는 소주 병 기준으로 2병까지만 가능합니다.',7,'음식을 먹어도 되나요?','2021-09-16 14:39:21','답변완료'),(138,'칭찬 감사합니다. 현재 운영되는 직원들 소리함은 운영되지 않습니다. 감사의 뜻을 직원들에게 전달하겠습니다. 언제나 만족을 우선으로 하는 저희 호텔 델루나가 되겠습니다.',6,'직원들 소리함은 있나요?','2021-09-16 14:40:05','답변완료'),(139,'예약한 패키지의 항목에 대해서는 마이페이지를 참고하시기 바랍니다.',5,'서비스에도 종류가 있나요?','2021-09-16 14:40:26','답변완료'),(140,'조식 할인은 예약 패키지 안에 다 포함된 가격이므로 따로 없습니다.',4,'조식은 얼마인가요?','2021-09-16 14:40:58','답변완료'),(141,'적립에 대한 사항은 마이페이지의 포인트 부분을 확인하시기 바랍니다.',3,'포인트 적립은 어떻게 진행되나요?','2021-09-16 14:41:22','답변완료'),(142,'코로나  4단계 격상에 따라 달라진 점은, 이전은 객실 최대 4인으로 가능합니다. 하지만 지금은 최대 2명입니다. ',2,'객실의 인원 제한은 몇 명인가요?','2021-09-16 14:42:01','답변완료'),(143,'회원, 비회원 모두 서비스를 받으실 수 있습니다.',1,'서비스는 누가 받을 수 있나요?','2021-09-16 14:42:22','답변완료');
